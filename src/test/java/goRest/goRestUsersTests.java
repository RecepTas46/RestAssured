...
//    id yi okuduk ve global bir değişkene attık ki, diğer reqest larde kullanabilelim
    ...
    public void createUser() {
        userID =
                given()
                        ...
                        .contentType(ContentType.JSON)
                        .body("{\"name\":\"recep\", \"gender\":\"male\", \"email\":\"" + getRandomEmail() + "\", \"status\":\"active\"}")
    ...
    public void getUpdateUserById() {
        String isim = "recep tas";//eger bir sey iki defa dan fazla kullaniliyorsa degiskene almak lazim
        given()
                .header("Authorization", "Bearer c9d90c12b6672f8536f97d67e8a704d63b0ba74bdf7e0fa9b79b8d3e356416dd")
                .contentType(ContentType.JSON)
                .body("{\"name\":\"" + isim + "\"}")
